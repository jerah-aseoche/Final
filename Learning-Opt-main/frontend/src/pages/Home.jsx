...
function HomePage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#1f1f1f] text-white relative">
      {/* Sidebar */}
      <Dashboard />

      {/* Main Content */}
      <div className="flex-1 relative ml-0 px-10 py-8 overflow-y-auto">
        {/* Fixed Logout Button */}
        <div className="absolute top-6 right-10 z-10">
          <button
            className="rounded-md bg-red-600 text-white px-4 py-2 font-medium hover:bg-red-700 transition"
            onClick={logout}
          >
            Logout
          </button>
