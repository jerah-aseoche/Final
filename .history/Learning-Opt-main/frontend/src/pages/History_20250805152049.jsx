...
function History() {
  ...
  return (
    <Dashboard>
      {/* Background */}
      <div className="fixed inset-0 bg-cover bg-center blur-lg -z-10" style={{ backgroundImage: "url('/background.jpg')" }}></div>
      <div className="absolute inset-0 bg-black/10 -z-10"></div>

      <div className="flex-1 p-3 mt-10 mr-5 ml-6 overflow-y-auto rounded-md">
