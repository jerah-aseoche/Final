...
function HomePage() {
  ...
  return (
    <div className="relative flex min-h-screen bg-zinc-800 text-white overflow-hidden">
      {/* Background */}
      <div
      ...
      <div className="flex-1 relative px-10 py-8 overflow-y-auto">
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="bg-[#696b6c]/70 rounded-xl p-10 shadow-xl text-center flex flex-col items-center w-full max-w-6xl">
            {/* Logo */}
            <img
              src="/CreotecLogo.png"
              alt="Creotec Logo"
