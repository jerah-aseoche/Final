...
def preview_certificate():
    ...
    if template_type == 'tesda':
        ...
        html_parts = [
            ...
            ".container { max-width: 1300px; width: 100%; padding: 10px; text-align: center; display: flex; flex-direction: column; align-items: center; height: 100vh; justify-content: space-between; }",
            ...
            ".tesda-card { max-width: 2700px; background: transparent; padding: 20px; display: none; flex-direction: column; align-items: center; margin: auto; }",
